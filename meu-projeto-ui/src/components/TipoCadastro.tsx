    ...
    <div className="p-5 rounded-lg mx-auto">
      <div className="flex items-center justify-center gap-4 mb-6">
        ...
        <h1
          ...
          className={`${latoBoldItalic.className} text-5xl font-bold italic text-[#fe5000] mb-1 cursor-pointer`}
        >
          Fiança Rápida
        </h1>
      </div>
      ...
      <h2 className="text-xl font-semibold text-center mb-6 text-[#fe5000]">Desejo cadastrar um:</h2>
